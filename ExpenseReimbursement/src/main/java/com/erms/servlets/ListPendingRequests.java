...
/**
 * Servlet implementation class ListPendingRequests
 */
@WebServlet(urlPatterns = "/listPendingRequests", name = "listPendingRequestsServlet")
public class ListPendingRequests extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		if (SessionManager.isLoggedIn(req, resp)) {
			...
			try {
				...
				List<Receipt> lstUsers = DBManager.getInstance().getRequests(currUser.getId(), "PENDING", true);
